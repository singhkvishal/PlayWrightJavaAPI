...
public class UpdateUserPUTCallWithPOJOLombokTest {
    ...
    public void updateUserTest() throws IOException {
        ...
        Users users = Users.builder()
                .name("Vishal Automation Test")
                .email(getRandomEmail())
                .gender("male")
                .status("active").build();

        //1. POST Call: create a user
        APIResponse apiPostResponse = requestContext.post("http://restapi.adequateshop.com/api/authaccount/login",
        ...
        users.setName("Vishal Automation Test");
