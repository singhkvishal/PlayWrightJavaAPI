...
public class CreateUserPostCallTest {
    ...
    public void createUserTest() throws IOException {
        ...
        data.put("firstname", "VishalAuto");
        data.put("lastname", getRandomEmail());
        data.put("totalprice", "male");
        data.put("depositpaid", "active");
        ...
        Assert.assertTrue(apiGetResponse.text().contains("VishalAuto"));
